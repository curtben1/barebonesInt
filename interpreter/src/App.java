...
public class App {
  ...
  public static String[][] generateCode() throws Exception {
     ...
     * unnecesary characters. It does not check for errors at this stage as it is interpreting not
     * compiling so can at runtime with no issues.
     */
  ...
  public static void execute(String[][] codeArr) throws Exception {
    /**
     * Method to read and execute the perviously formed code Array uses a for loop to iterate over
     * each "line" and a switch case structure to check each instruction and a hash map to store
     * variables. Becomes recursive if there is a while loop in the bare bones code. This does mean
     * the memory performance of the while statement is incorrect but should not matter too much
     */
    int newVal;
    int lineNum = 0;
